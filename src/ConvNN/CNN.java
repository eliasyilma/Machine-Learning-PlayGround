 ...
 *
 * The CNN consists of four layers namely: -the convolution layer
 * (Convolution.java) -the maximum pooling layer (MaxPool.java) -the softmax
 * activation layer (SoftMax.java) -the output layer that implements
 * cross-entropy loss.
 *
 *
 *
...
public class CNN {
    ...
    public void training_step() throws IOException {
            ...
            predicted_label=Mat.v_argmax(out_l);
            accuracy += correct_label ==  predicted_label ? 1 : 0;
            ...
            if (step_counter % 100 == 99) {
                System.out.println(" step: " + step_counter + " loss: " + ce_loss / 100.0 + " accuracy: " + accuracy);
                ce_loss = 0;
                acc_sum += accuracy;
                accuracy = 0;
            }
