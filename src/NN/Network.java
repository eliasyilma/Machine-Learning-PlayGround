...
import static NN.Node.discretize;
...
public class Network {
    ...
    /**
     * computes the total loss from the network
     */
    ...
    /**
     * the back-propagation pass of the perceptron, updates the weights of the links
     * and the bias value of each node in the network except for the input/feature layer.
     */
    ...
    /**
     * the forward pass of the perceptron , where activation value of each node is computed
     * for a specific x1,x2 data point injested through the feature layer.
     * (the feature layer computes the corresponding label values defined by the function of that feature
     * eg. f(x1,x2)=sin(x1)...)
     */
